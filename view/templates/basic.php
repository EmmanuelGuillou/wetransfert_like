                            ...
                            <tbody>
                              <tr>
                                <th class="small-6 large-6 columns first" valign="middle">
                                  <table>
                                    <tr>
                                      <th> <img src="http://placehold.it/200x50/663399"> </th>
                                    </tr>
                                  </table>
                                </th>
                            ...
                            <table>
                              <tr>
                                <th>
                                  ...
                                  <p>Vous trouverez le lien juste en dessous</p>
                                  <table class="callout">
                                    <tr>
                                      <th class="callout-inner primary">
                                        <p><a href="'.$url2.'index.php?fichier='.$url_file.'">Lien vers le fichier</a></p>
                                      </th>
                      ...
                      <tr>
                        <td class="wrapper-inner">
                          <table class="spacer">
                            <tbody>
                              <tr>
                                <td height="16px" style="font-size:16px;line-height:16px;">Message :<br/>
